...
class TestFENGenerator(unittest.TestCase):
    ...
    def test_genFEN_AfterInitialPosition(self):
        FENGen = fen.FENGenerator(
            'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w')
        FENGen.fen_after_move('e4')
        self.assertEqual(
            'rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR', FENGen.fen)
    ...
    def test_genFEN_AfterInitialPositionNf3(self):
        ...
        self.assertEqual(
            'rnbqkbnr/pppppppp/8/8/8/5N2/PPPPPPPP/RNBQKB1R', FENGen.fen)
    ...
    def test_AfterSecondMove(self):
        ...
        self.assertEqual(
            'rnbqkbnr/pp1ppppp/8/2p5/4P3/8/PPPP1PPP/RNBQKBNR', FENGen.fen)
    ...
    def test_AfterThirdMove(self):
        ...
        FENGen.fen_after_move('Nf3')
        self.assertEqual(
            'rnbqkbnr/pp1ppppp/8/2p5/4P3/5N2/PPPP1PPP/RNBQKB1R', FENGen.fen)
    ...
    def test_After4thMove(self):
        ...
        self.assertEqual(
            'r1bqkbnr/pp1ppppp/2n5/2p5/4P3/5N2/PPPP1PPP/RNBQKB1R', FENGen.fen)
    ...
    def test_After5thMove(self):
        ...
        self.assertEqual(
            'r1bqkbnr/pp1ppppp/2n5/1Bp5/4P3/5N2/PPPP1PPP/RNBQK2R', FENGen.fen)
    ...
    def test_After6thMove(self):
        ...
        self.assertEqual('r1bqkb1r/pp1ppppp/2n2n2/1Bp5/4P3/5N2/PPPP1PPP/RNBQK2R',
                         FENGen.fen)
    ...
    def test_After7thMove(self):
        ...
        self.assertEqual('r1bqkb1r/pp1ppppp/2n2n2/2p5/4P3/5N2/PPPP1PPP/RNBQKB1R',
                         FENGen.fen)
    ...
    def test_After8thMove(self):
        ...
        self.assertEqual(
            'r1bqkb1r/pp1ppppp/2n5/2p5/4n3/5N2/PPPP1PPP/RNBQKB1R', FENGen.fen)
    ...
    def test_ForWhiteKingSideCastling(self):
        ...
        self.assertEqual('r1bqkb1r/pp1ppppp/2n2n2/1Bp5/4P3/5N2/PPPP1PPP/RNBQ1RK1',
                         FENGen.fen)
    ...
    def test_ForWhiteQueenMove(self):
        ...
        self.assertEqual(
            'rnbqkbnr/pp1ppppp/8/2p5/4P3/8/PPPPQPPP/RNB1KBNR',
            FENGen.fen)
    ...
    def test_ForBlackQueenMove(self):
        ...
        self.assertEqual(
            'rnb1kbnr/ppqppppp/8/2p5/4P3/8/PPPPQPPP/RNB1KBNR', FENGen.fen)
    ...
    def test_ForWhiteKingMove(self):
        ...
        self.assertEqual(
            'rnb1kbnr/ppqppppp/8/2p5/4P3/8/PPPPQPPP/RNBK1BNR', FENGen.fen)
    ...
    def test_ForBlackKingMove(self):
        ...
        self.assertEqual(
            'rnbk1bnr/ppqppppp/8/2p5/4P3/8/PPPPQPPP/RNBK1BNR', FENGen.fen)
    ...
    def test_ForCaptureByBlackPawn(self):
        ...
        self.assertEqual(
            'rnbqkbnr/pppp1ppp/8/8/3pP3/8/PPP2PPP/RNBQKBNR', FENGen.fen)
    ...
    def test_ForCaptureByWhitePawn(self):
        ...
        self.assertEqual(
            'rnbqkbnr/ppp2ppp/3p4/4P3/4P3/8/PPP2PPP/RNBQKBNR', FENGen.fen)
    ...
    def test_ForRookMoveHorizontally_When2RooksCanmove(self):
        ...
        self.assertEqual(
            'rnbqkb1r/pp2pppp/3p1n2/8/3NP3/2N5/PPP2PPP/R1BQKB1R', FENGen.fen)
    ...
    def test_ForKnightMove_When2KnightsCanmove(self):
        ...
        self.assertEqual(
            'rnbqkb1r/1p2pppp/p2p1n2/1N6/3NP3/8/PPP2PPP/R1BQKB1R', FENGen.fen)
    ...
    def test_ForWholeGame(self):
        ...
        self.assertEqual(
            '1rb2rk1/2qn1Bpp/pp2p3/2b1P3/P2B4/2N5/1PP2QPP/3R1R1K', FENGen.fen)
        ...
        self.assertEqual(
            '1rb2r1k/2q2Bpp/p3p3/2p1n3/P2B4/8/1PP2QPP/3R1R1K', FENGen.fen)
        ...
        self.assertEqual(
            '1rb3r1/6pk/p3p3/2p1q3/P6Q/8/1PP3PP/3R1R1K', FENGen.fen)
        FENGen.fen_after_move('Kg6')
        FENGen.fen_after_move('Rd3')
        self.assertEqual(
            '1rb3r1/6p1/p3p1k1/2p1q3/P6Q/3R4/1PP3PP/5R1K', FENGen.fen)
        FENGen.fen_after_move('Qh5')
        FENGen.fen_after_move('Rg3+')

        self.assertEqual(
            '1rb3r1/6p1/p3p1k1/2p4q/P6Q/6R1/1PP3PP/5R1K', FENGen.fen)
    ...
    def test_ForRookMoveHorizontally_When2RooksCanmove1(self):
        ...
        self.assertEqual(
            'r4Nk1/pp1bbn1p/1q4p1/3ppP2/6Q1/6N1/PPP3PP/R1B2R1K', FENGen.fen)
...
#8. Bh4 g5 9. Nxg5 hxg5 10. Bxg5 Nbd7 11. exf6 Bb7 12. g3 c5
    def test_gameva(self):
        ...
        self.assertEqual(
            '2k3r1/pr3pP1/8/1qN5/1ppp4/4B1P1/1P3P1P/R4RK1', FENGen.fen)
    ...
    def test_2whitepawansseparatedbyonerank(self):
        ...
        FENGen.fen_after_move('e5')
        self.assertEqual(
            'rnbqkbnr/ppp2ppp/3p4/4p3/4PP2/8/PPPP2PP/RNBQKBNR', FENGen.fen)
        FENGen.fen_after_move('fxe5')
        self.assertEqual(
            'rnbqkbnr/ppp2ppp/3p4/4P3/4P3/8/PPPP2PP/RNBQKBNR', FENGen.fen)
        FENGen.fen_after_move('c6')
        self.assertEqual(
            'rnbqkbnr/pp3ppp/2pp4/4P3/4P3/8/PPPP2PP/RNBQKBNR', FENGen.fen)
        FENGen.fen_after_move('e6')

        self.assertEqual(
            'rnbqkbnr/pp3ppp/2ppP3/8/4P3/8/PPPP2PP/RNBQKBNR', FENGen.fen)
        ...
        self.assertEqual(
            'rnbqkb1r/pp3ppp/2ppPn2/4P3/8/8/PPPP2PP/RNBQKBNR', FENGen.fen)
    ...
    def test_RooksOn_a5_and_a1_moveto_R1a3(self):
        ...
        self.assertEqual(
            '2k1r3/pr4P1/5p2/1qN5/1ppp4/R3B1P1/1P3P1P/R5K1', FENGen.fen)
    ...
    def test_enpassant_blackpawncaptured(self):
       ...
       # FENGen.fen_after_move('f6')
        ...
        self.assertEqual(
            'rnbqkbnr/pppp2pp/4pP2/8/8/8/PPPP1PPP/RNBQKBNR', FENGen.fen)
    ...
    def test_enpassant_whitepawncaptured(self):
       ...
       # FENGen.fen_after_move('f6')
        ...
        self.assertEqual(
            'rnbqkbnr/pp1ppppp/8/8/8/3pPP2/PPP3PP/RNBQKBNR', FENGen.fen)
